/* unzip.c -- IO for uncompress .zip files using zlib
   ...
   G.Barrand : KG -> ANSI C args function declaration.
*/
...
#include <stdlib.h>
#include <string.h>
#ifdef EXLIB_USE_NATIVE_ZLIB /*G.Barrand*/
#include "zlib.h"
#else
#include "ourex_zlib.h" /*G.Barrand : enforce ourex/zlib */
#endif
#include "../include/ourex_unzip.h" /*G.Barrand*/
					...
					unsigned len)
{
    ...
    if (pfile_in_zip_read_info->read_buffer == NULL) /*GB : rm double()*/
        return UNZ_END_OF_LIST_OF_FILE;
    if (len==0)
        return 0;
